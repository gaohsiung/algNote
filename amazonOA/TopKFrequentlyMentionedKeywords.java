...
public class TopKFrequentlyMentionedKeywords {
    ...
    public static void main(String[] args) {
        TopKFrequentlyMentionedKeywords tkfmk = new TopKFrequentlyMentionedKeywords();
        int k1 = 2;
        ...
        System.out.println(tkfmk.solve(k1, keywords1, reviews1));
        System.out.println(tkfmk.solve(k2, keywords2, reviews2));
    }
}